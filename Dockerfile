...
RUN aws s3 cp s3://mytrainedmodels/vehicles_model/ evaluate(python -c "import vehicles_model; import os; print(os.path.dirname(vehicles_model.__file__))"+"/trained_models" ) --recursive
